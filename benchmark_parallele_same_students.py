...
def simulate_one_student(l, dim_theta, n_rounds, exploration_parameter, lambda_, corpus, cold_start_len, 
                         item_removal, knowledge_evolving_time_step, epsilon, reward_methods):
    ...
    student_results = {method_name: {'expected_rewards': np.zeros(n_rounds),
...
def plot_average_metrics(dim_theta, n_students, n_rounds, exploration_parameter, lambda_, corpus, 
                         cold_start_len, item_removal, knowledge_evolving_time_step, epsilon):
    ...
    results = Parallel(n_jobs=-1, verbose=10)(
        delayed(simulate_one_student)(
            l, dim_theta, n_rounds, exploration_parameter, lambda_, corpus, cold_start_len,
            item_removal, knowledge_evolving_time_step, epsilon, reward_methods
        )
